...
`;
  ...
  // Production (root in Docker): @sparticuz/chromium extracts its
  //   crashpad-free binary to /tmp/chromium — root always has write access.
  // Windows dev: prefer local Chrome.
  let executablePath;
